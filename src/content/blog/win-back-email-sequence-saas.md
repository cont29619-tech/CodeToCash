...
For the broader picture on why customers leave and how to prevent it, read the [churn reduction tactics guide](/blog/reduce-churn-saas-tactics). Win-back is the last line of defense; retention is the fortress wall.
...
1. Tag churned customers with "churned-[date]"
2. Create an automation triggered by that tag
3. Add each email with a delay between them
4. Remove the tag if they reactivate

**Loops:**

1. Create a "churned" segment
2. Build a drip campaign with the 5 emails
3. Set exit condition: "user starts paying again"

**Postmark/Loops (transactional):**

1. Trigger the sequence from your backend when a subscription is canceled
2. Pass the churn reason as a custom property if you collect it
3. Personalize Email 2 based on that property
