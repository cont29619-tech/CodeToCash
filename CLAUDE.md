...
```html
<div
  class="p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06]
...
```html
<button
  class="px-8 py-4 bg-coral text-white font-semibold rounded-lg
...
<input
  type="email"
  class="flex-1 px-5 py-4 bg-white/5 border border-white/10 rounded-lg
